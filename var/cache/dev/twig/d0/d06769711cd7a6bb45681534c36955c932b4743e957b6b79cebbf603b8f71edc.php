...
/* post/edit.html.twig */
class __TwigTemplate_5e3942aa0e5fbc7c3d72e783a8046ae35d743fe4d5c0f4b1e45a724f89914e46 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container col-md-6 offset-3\">
    ...
    ";
        // line 10
        echo twig_include($this->env, $context, "post/_form.html.twig", ["button_label" => "Actualizar"]);
        echo "

    <div class=\"d-flex flex-row mr-2 justify-content-sm-between mt-1\">
...
";
    ...
    {
        return array (  104 => 14,  100 => 13,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container col-md-6 offset-3\">
    ...
    {{ include('post/_form.html.twig', {'button_label': 'Actualizar'}) }}

    <div class=\"d-flex flex-row mr-2 justify-content-sm-between mt-1\">
        <a class=\"btn btn-primary\" href=\"{{ path('post_index') }}\">Volver</a>
...
{% endblock %}
", "post/edit.html.twig", "/Users/italoramirezprieto/Documents/symfony/pruebas_symfony/templates/post/edit.html.twig");
    }
}
